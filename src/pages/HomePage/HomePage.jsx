import { Box, Button, Stack, Typography, Card, CardHeader, CardContent } from '@mui/material'
...
const HomePage = () => {
  return (
    <Box sx={{ px: 20, pb: 10 }}>
      ...
      <Stack direction='row' spacing={2} justifyContent='center' alignItems='center' sx={{ height: 'auto', pt: 4 }}>
        <Card
          sx={{
            width: '20%',
            height: '100%',
      ...
      <Stack direction='row' spacing={2} sx={{ height: 'auto', pt: 4 }}>
        <Card
          sx={{
            width: '50%',
            height: '100%'
        ...
        >
          ...
          <CardContent>
            ...
            <br />
            3. Contact and Hire Experts: When you find a suitable expert, get in touch with them and start your chat or
            project right away.
          </CardContent>
        </Card>
      </Stack>
